...
//  ProgressRoundView
//
//  Created by Максим Савченко on 2020/10/18.
...
class JDRoundLayer:JDLayerClass
{
    init(LineWidth w:CGFloat,theBounds:CGSize,Stroke_Color:CGColor,percent:CGFloat) {
        ...
        self.lineCap = CAShapeLayerLineCap(rawValue: "kCALineCapRound")
        self.lineJoin = CAShapeLayerLineJoin(rawValue: "kCALineJoinRound")
        self.lineWidth = w
